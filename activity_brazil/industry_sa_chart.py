...
layout = go.Layout(title="<b>Industrial Production</b>", legend=dict(x=0, y=-0.4),
                   font=dict(size=18), yaxis=dict(title="%mom", tickmode="auto", nticks=5))
fig = go.Figure(data=data, layout=layout)
py.image.save_as(fig, "../exhibits/industry_total_chart.jpeg", format="jpeg")
