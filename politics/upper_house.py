...
df = pd.read_csv('../data/upper_house.csv', header=0)
df.columns = ['nome', "uf", 'periodo', 'partido']
...
figure = gen_chart("Temer's Coalision Base - Upper House")
py.image.save_as(figure, filename='treemap_upper_house.jpeg', format='jpeg')
